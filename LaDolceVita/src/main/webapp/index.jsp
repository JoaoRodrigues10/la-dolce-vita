...
<div class="container text-center">
    <div class="row">
        ...
        <div class="col-md-4"><h2> VISÃO</h2>
            </br>

            <h5>Ser reconhecida como a confeitaria referência em excelência, criatividade e sabor irresistível, proporcionando momentos de doçura e felicidade aos nossos clientes.
            </h5></div>

        <div class="col-md-4 offset-md-4"><h2>MISSÃO</h2>
            </br>
            <h5>Criar e oferecer produtos de confeitaria excepcionais, utilizando ingredientes de alta qualidade, técnicas artesanais e uma dose generosa de paixão,
                para encantar os paladares mais exigentes e tornar cada momento especial e memorável.</h5>
            </br>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-8 offset-md-2"><h2>VALORES</h2>
            ...
            <h5>Comprometemo-nos com qualidade em cada etapa do processo, desde a escolha dos ingredientes até a apresentação final dos produtos. Incentivamos a inovação e
                ...
                transparência e respeito em todas as relações. Priorizamos a satisfação do cliente, buscando sempre superar expectativas.</h5>
        </div>
    </div>
</div>
</br></br></br>
