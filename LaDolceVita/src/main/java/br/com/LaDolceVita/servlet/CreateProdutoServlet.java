...
public class CreateProdutoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String produtoName = parameters.get("name-produto");
        String produtoCategoria = parameters.get("categoria-produto");
        String produtoDescricao = parameters.get("descricao-produto");
        String preco = parameters.get("preco-produto");
